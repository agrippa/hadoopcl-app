...
public class GenerateSimpleBSparse extends CompressedInputGenerator {
    ...
    public Class getValueClass() {
        return BSparseVectorWritable.class;
    }
    ...
    public void writeNextKeyValue(SequenceFile.Writer writer, int globalIndex, int globalTotal) throws IOException {
        ...
        writer.append(new IntWritable(globalIndex), 
                new BSparseVectorWritable(newIndices, newVals));
    }

    public static void main(String[] args) {
        if(args.length != 3) {
            System.out.println("usage: java GenerateSimpleBSparse outputFolderContainer nFiles elementsPerFile");
            return;
        }
        ...
        new GenerateSimpleBSparse().writeAllTypes(outputFolderContainer, nFiles, perFile);
