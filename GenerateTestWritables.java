...
public class GenerateTestWritables extends CompressedInputGenerator {
    ...
    public static void main(String[] args) {
        if(args.length != 3) {
            System.out.println("usage: java GenerateTestWritables outputFolderContainer nFiles elementsPerFile");
            return;
        }
        ...
        new GenerateTestWritables().writeAllTypes(outputFolderContainer, nFiles, perFile);
