...
# ${HADOOP_HOME}/bin/hadoop fs -put /scratch/jmg3/asf-sparse/tfidf-vectors-transformed-merged/ input
${HADOOP_HOME}/bin/hadoop fs -put /scratch/jmg3/wiki-sparse/tfidf-vectors-transformed-merged/ input
sleep 30
