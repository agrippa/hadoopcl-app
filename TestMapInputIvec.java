...
public class TestMapInputIvec {
    ...
    public static class TestMapper extends IntIvecIntIntHadoopCLMapperKernel {
        protected void map(int key, int[] vals, int len) {
            int sum = vals[1];
            // sum = sum + vals[1];
            // sum = sum + vals[2];
            write(key, (int)sum);
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = new Job(conf, "test-map-ivec-input");
        job.setJarByClass(TestMapInputIvec.class);
