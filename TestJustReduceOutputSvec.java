...
public class TestJustReduceOutputSvec {
    public static class TestReducer extends IntIntIntSvecHadoopCLReducerKernel {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = new Job(conf, "test-just-reduce-svec-output");
        job.setJarByClass(TestJustReduceOutputSvec.class);
